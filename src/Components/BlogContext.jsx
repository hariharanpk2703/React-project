...
const TourDetails = (props) => {
    ...
    let [Bollywood, setBollywood] = useState([
        
            {
                ...
                info: "Advait Chandan shared a BTS picture of Aamir Khan from the sets. (courtesy: advaitchandan)As the time is nearing for the launch ofLaal Singh Chaddha trailer, the makers are keeping the momentum hig… [+2109 chars]",
        },
        {
            id: "14",
